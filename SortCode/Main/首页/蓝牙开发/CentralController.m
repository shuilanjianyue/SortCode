...
//系统蓝牙设备管理对象，可以把他理解为主设备，通过它，可以去扫描和链接外设
...
- (void)viewDidLoad {
    ...
    self.navBar.titleLabel.text = @"蓝牙开发";
...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central{
    ...
    switch (central.state) {
        ...
        case CBCentralManagerStatePoweredOn:
            ...
            //开始扫描周围的外设
            /*
             第  一个参数nil就是扫描周围所有的外设，扫描到外设后会进入
...
-(void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI{
    ...
    NSLog(@"kCBAdvDataManufacturerData:%@",[advertisementData objectForKey:@"kCBAdvDataManufacturerData"]);
    
//    NSData *dates = [advertisementData objectForKey:@"kCBAdvDataManufacturerData"];
//    
//    NSString *result = [[NSString alloc] initWithData:dates  encoding:NSUTF8StringEncoding];
