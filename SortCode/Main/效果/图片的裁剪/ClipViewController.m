//
//  ClipViewControllerController.m
//  整理文
//
...
-(void)CreatUI
{
    ...
    [clipBtn setBackgroundColor:[UIColor greenColor]];
...
-(void)drawClipPath:(ClipType )clipType
{
    ...
    UIBezierPath * path= [UIBezierPath bezierPathWithRect:CGRectMake(0, 44, ScreenWidth, ScreenHeight)];
