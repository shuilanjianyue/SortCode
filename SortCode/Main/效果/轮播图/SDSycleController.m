...
@interface SDSycleController ()<SDCycleScrollViewDelegate>

@end

@implementation SDSycleController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navBar.titleLabel.text = @"轮播图";
    
    
    
    UIScrollView *demoContainerView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, NavHeight, SCREEN_WIDTH, SCREEN_HEIGHT - NavHeight)];
