...
@interface MBProgressController ()<UITableViewDataSource,UITableViewDelegate,NSURLSessionDelegate>
...
- (void)viewDidLoad {
    ...
    self.navBar.titleLabel.text = @"MBProgressHUD";
    
    
    
    self.myTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, NavHeight, SCREEN_WIDTH, SCREEN_HEIGHT-64) style:UITableViewStyleGrouped];
    //去掉背景色
